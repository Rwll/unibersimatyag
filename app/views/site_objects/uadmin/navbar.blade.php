<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <label class="navbar-brand">Hi,</label><a class="navbar-brand" href="{{ URL::Route('univ-admin-profile') }}">University Admin!</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ URL::Route('univ-admin-profile') }}"><i class="fa fa-user fa-fw"></i>  Profile</a></li>
                        <li><a href="{{ URL::Route('univ-admin-account-settings') }}"><i class="fa fa-wrench fa-fw"></i>  Account Settings</a></li>
                        <li class="divider"></li>
